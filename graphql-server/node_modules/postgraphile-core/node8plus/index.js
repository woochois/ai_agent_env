...
const getPostGraphileBuilder = async (pgConfig, schemas, options = {}) => {
    ...
    live = false, ownerConnectionString, usePartitionedParent = false, } = options;
